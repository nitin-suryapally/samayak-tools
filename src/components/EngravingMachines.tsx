    ...
    <section className="relative w-full flex justify-center items-center py-10 bg-white">
      <div className="relative w-full max-w-7xl rounded-2xl bg-black overflow-hidden px-4 py-10 md:py-14 flex flex-col items-center">
        ...
        <div className="relative z-20 flex flex-col items-center space-y-2">
          <h2 className="text-2xl md:text-4xl font-black text-white text-center mb-2">
            Ready To Get Started?
          </h2>
          <div className="font-semibold text-white text-lg md:text-2xl text-center mb-8 tracking-wide">
            Engraving Machines
          </div>
        </div>
        {/* Machine Cards */}
        <div className="relative z-20 flex flex-col gap-10 md:flex-row md:gap-0 w-full justify-center items-center">
        ...
        {/* Explore button below center card */}
